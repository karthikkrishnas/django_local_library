    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.TextField(help_text='Enter a brief description of the book in a few sentences', max_length=1000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imprint', models.CharField(help_text='Enter the version details', max_length=200)),
        ...
        migrations.AddField(
            model_name='book',
            name='language',
            field=models.ForeignKey(help_text='Select language for this book', null=True, on_delete=django.db.models.deletion.SET_NULL, to='catalog.language'),
        ),
    ]
